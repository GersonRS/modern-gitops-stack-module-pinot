...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/data-sources/service[kubernetes_service.pinot] (data source)
...
|[[output_cluster_dns]] <<output_cluster_dns,cluster_dns>> |pinot cluster dns
|[[output_cluster_ip]] <<output_cluster_ip,cluster_ip>> |pinot cluster ip internal
|[[output_endpoint]] <<output_endpoint,endpoint>> |pinot endpoint external
|===
// END_TF_TABLES
====
